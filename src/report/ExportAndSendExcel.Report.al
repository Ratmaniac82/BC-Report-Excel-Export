report 50120 "PPI Export And Send Excel"
{
    ...
    var
        ...
        EmailHelper: Codeunit "PPI Email Helper";
    ...
    begin
        ...
        EmailHelper.SendEmail('marcoratti@gmail.com', '', '', 'Sample Email', EmailScenario::Default, TempBlob, 'Email From BC.xlsx');
